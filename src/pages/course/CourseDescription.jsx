                ...
                <div className="grid grid-cols-2 gap-10 py-10 relative">
                    <div className="space-y-5 flex flex-col items-center justify-center">
                        <div className="space-y-4">
                            ...
                            {role === "ADMIN" || data?.user?.subscription?.status === 'active' ? (
                                <button
                                    onClick={() => navigate("/Dashboard/DisplayLecture", { state: { ...state } })}
                                    className="bg-yellow-500 text-xl rounded-md font-bold px-5 py-3 w-full hover:bg-yellow-600 transition-all ease-in-out duration-300"
                                >
                                    Watch Lectures
                                </button>
                    ...
                    <div className="space-y-2 text-xl">
                        <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-red-500 mb-5 text-center shadow-lg">
